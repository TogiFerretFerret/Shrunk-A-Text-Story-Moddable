...
# Notes: Search for disclaimerRead = str(fkey.getchars(chars=["y", "n"])) , I removed it for testing, leave it in final
...
def sparrowEncounterTwo():
    ...
    os.system("clear")
    jrv = jread('sparrowEncounter2',"sparrowEncounters.json")
    jrc = jread('sparrowEncounter2',"sparrowChoices.json")
    printt(eval(f'f"""{jrv[0]}"""'), userStrDelay) # i dont even how this tf this terrible f string works exactly... it uses multiline f strings to account for \n in messages tho
    time.sleep(0.5)
    printt(eval(f'f"""{jrv[1]}"""'), userStrDelay)
    time.sleep(0.5)
    printt(eval(f'f"""{jrv[2]}"""'), userStrDelay)
    time.sleep(0.5)
    os.system("clear")
    printt(eval(f'f"""{jrv[3]}"""'), userStrDelay)
    time.sleep(0.5)
    printt(eval(f'f"""{jrv[4]}"""'), userStrDelay)
    time.sleep(0.5)
    os.system("clear")
    printt(eval(f'f"""{jrv[5]}"""'), userStrDelay)
    time.sleep(0.5)
    printt(eval(f'f"""{jrv[6]}"""'), userStrDelay)
    time.sleep(0.5)
    printt(eval(f'f"""{jrv[7]}"""'), userStrDelay)
    time.sleep(0.5)
    printt(jrc[0], userStrDelay)
    printt(jrc[1], userStrDelay)
    printt(jrc[2], userStrDelay)
